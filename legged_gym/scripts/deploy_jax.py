...
def load_checkpoint(dir):
    ...
    dir, orbax_checkpointer, options)

    step = checkpoint_manager.latest_step()  # step = 4
    agent = checkpoint_manager.restore(step)
...
def main(cfg: DeployScriptConfig):
    ...
    ## Load agent
    saved_agent_dir = "/home/mateo/projects/experiment_logs/scratch_rlpd/2024-06-20_14-38-26/agents"
    agent = load_checkpoint(saved_agent_dir)
