...
# asset_file = "urdf/simplecar.urdf"
asset_root = "ground_control_base/resources"
asset_file = "simplecar.urdf"
...
car_asset = gym.load_asset(sim, asset_root, asset_file, asset_options)
...
car0 = gym.create_actor(env0, car_asset, initial_pose, 'car', 0, 1)
# Configure DOF properties
"""
{'base_to_left_back_wheel': 0, 'base_to_left_hinge': 1, 'base_to_right_back_wheel': 3, 'base_to_right_hinge': 4, 'left_hinge_to_left_front_wheel': 2, 'right_hinge_to_right_front_wheel': 5}
"""
props = gym.get_actor_dof_properties(env0, car0)
dof_dict = gym.get_actor_dof_dict(env0, car0)
...
# pole_dof_handle0 = gym.find_actor_dof_handle(env0, car0, 'cart_to_pole')
