...
sources = [
    "robot_deployment/convex_mpc_controller/mpc_osqp.cc",
...
setup(
    name='robot_deployment',
    version='1.0.0',
    description='Convex MPC controller with python bindings for MPC using the osqp solver',
    long_description='Convex MPC controller with python bindings for MPC using the PyBullet and the OSQP solver',
