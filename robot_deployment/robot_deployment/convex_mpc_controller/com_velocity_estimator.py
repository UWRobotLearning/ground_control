...
from robot_deployment.convex_mpc_controller.gait_generator import LegState
from robot_deployment.utilities.moving_window_filter import MovingWindowFilter
...
class COMVelocityEstimator(object):
  ...
  def com_rpy_rate_ground_frame(self):
    com_quat_world_frame = p.getQuaternionFromEuler(self._robot.base_angular_velocity_in_base_frame)
    _, world_orientation_ground_frame = p.invertTransform(
        [0., 0., 0.], self.ground_orientation_world_frame)
