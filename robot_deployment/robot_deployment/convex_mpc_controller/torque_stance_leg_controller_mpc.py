...
from robot_deployment.convex_mpc_controller import gait_generator as gait_generator_lib
...
class TorqueStanceLegController:
  ...
  def get_action(self):
    ...
    # print("Com RPY Rate: {}".format(self._robot.base_angular_velocity_in_base_frame))
    ...
    predicted_contact_forces = self._cpp_mpc.compute_contact_forces(
        ...
        self._robot.base_angular_velocity_in_base_frame,
